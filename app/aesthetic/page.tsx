...
export default function AestheticPage() {
  ...
  const handleQueueVideo = async () => {
    ...
    try {
      ...
      // Calculate total duration in seconds from frames (30fps)
      let totalFrames = 0;
      ...
      const response = await fetch('/api/queue-video', {
        ...
        body: JSON.stringify({ 
          ...
          showSubtitles: false, // Purely visual
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {step === 2 && (
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-8 border border-gray-100 dark:border-gray-700 space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Step 2: Review & Upload Images</h2>
            <p className="text-gray-500">Upload images for each scene based on the generated prompts.</p>
